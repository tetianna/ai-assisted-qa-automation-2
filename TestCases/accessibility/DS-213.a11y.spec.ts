...
test.describe('DS-213 Settings add-user accessibility', () => {
  ...
  test('Settings page has no axe violations', { tag: '@sanity' }, async ({ page }) => {
    const settingsPage = new SettingsPage(page);
  ...
  test('Add User modal has no axe violations', { tag: '@sanity' }, async ({ page }) => {
    const settingsPage = new SettingsPage(page);
  ...
  test('Add User opens from keyboard focus on Add User control', { tag: '@sanity' }, async ({ page }) => {
    const settingsPage = new SettingsPage(page);
