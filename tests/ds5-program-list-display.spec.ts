...
test.describe('DS-5: Program list filtering and display', () => {
  ...
  test.describe('Happy paths', () => {
    test('TC-001 — Program list displays name and description for each program', async ({
      page,
      trackProgram,
    }) => {
      const programsPage = new ProgramsPage(page);
  ...
  test.describe('Negative', () => {
    ...
    test.fixme('TC-008 — API failure shows error state instead of misleading empty list', { tag: '@network' }, async ({
      page,
    }) => {
      const programsPage = new ProgramsPage(page);
  ...
  test.describe('Edge cases', () => {
    ...
    test('TC-013 — Special characters in name and description render correctly', async ({
      page,
      trackProgram,
    }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test('TC-016 — Emoji in program name and description display correctly', async ({
      page,
      trackProgram,
    }) => {
      const programsPage = new ProgramsPage(page);
