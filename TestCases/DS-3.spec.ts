...
import { uniqueName, watchProgramCreates } from '../tests/helpers/didaxis';
...
test.describe('DS-3: Program name validation and duplicate prevention', () => {
  ...
  test.describe('Happy paths', () => {
    test('TC-001 — Valid program name with special characters is accepted', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test('TC-002 — Standard alphanumeric program name is accepted', { tag: '@sanity' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test('TC-003 — Program name with hyphens and numbers is accepted', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
  ...
  test.describe('Negative', () => {
    test('TC-004 — Whitespace-only program name is rejected', { tag: '@regression' }, async ({ page }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test('TC-005 — Empty program name is rejected', { tag: '@sanity' }, async ({ page }) => {
      const programsPage = new ProgramsPage(page);
      await programsPage.openNewProgramForm();
      await expect(programsPage.newProgramModal.createButton).toBeDisabled();
    });

    test('TC-006 — Duplicate program name is rejected on create', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
      const name = uniqueName('Web Development 2026');
      const modal = programsPage.newProgramModal;
    ...
    test('TC-007 — Case-insensitive duplicate name is rejected', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test('TC-008 — Duplicate name after trim is rejected', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test('TC-009 — Program is not created when validation API fails', { tag: '@api' }, async ({ page }) => {
      const programsPage = new ProgramsPage(page);
  ...
  test.describe('Edge cases', () => {
    test('TC-010 — Program name at maximum length passes validation', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test('TC-011 — Program name one character over max length is rejected', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
      const modal = programsPage.newProgramModal;
    ...
    test('TC-012 — Single-character program name passes validation', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test('TC-013 — Unicode and emoji in program name pass validation', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test('TC-014 — Disallowed special characters are rejected with clear message', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test('TC-015 — Leading and trailing whitespace is trimmed before duplicate check', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test('TC-016 — Tab and newline characters in name are handled', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
      const modal = programsPage.newProgramModal;
    ...
    test('TC-017 — Duplicate prevention on edit when renaming', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test.fixme('TC-018 — Concurrent duplicate create results in at most one program', { tag: '@regression' }, async ({ browser, trackProgram }) => {
