Feature: DS-K1 — Add user in Settings
  DS-212 — Admin can add a new user from the Settings page
  ...
  # - Ticket only states "User should be able to add user in Settings" with no formal AC list.
