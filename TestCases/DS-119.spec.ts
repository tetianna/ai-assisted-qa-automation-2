...
import { formatViolations, recordViolations } from '../tests/helpers/a11y';
...
test.describe('DS-119: Dashboard displaying the right components', () => {
  ...
  test('TC-001 — Navigate to the Dashboard', { tag: '@smoke' }, async ({ page }) => {
    const homePage = new HomePage(page);
  ...
  test('TC-002 — Successfully navigate to Program Page', { tag: '@e2e' }, async ({ page }) => {
    const homePage = new HomePage(page);
  ...
  test('TC-003 — Successfully navigate to Calendar Page', { tag: '@e2e' }, async ({ page }) => {
    const homePage = new HomePage(page);
  ...
  test('TC-004 — Successfully navigate to Validation Page', { tag: '@e2e' }, async ({ page }) => {
    const homePage = new HomePage(page);
  ...
  test('TC-005 — Successfully navigate to AI Assist Page', { tag: '@e2e' }, async ({ page }) => {
    const homePage = new HomePage(page);
  ...
  test('TC-006 — Dashboard block cards are not duplicated in the main content area', { tag: '@sanity' }, async ({ page }) => {
    const homePage = new HomePage(page);
  ...
  test('TC-007 — Dashboard remains visible after returning from Programs page', { tag: '@e2e' }, async ({ page }) => {
    const homePage = new HomePage(page);
    const programsPage = new ProgramsPage(page);
