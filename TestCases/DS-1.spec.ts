...
test.describe('DS-1: Create New Academic Program', () => {
  ...
  test.describe('Happy paths', () => {
    test('TC-001: Program creation form displays required fields', { tag: '@sanity' }, async ({ page }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test('TC-002: New program appears in list after successful creation', { tag: '@smoke' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test('TC-003: Create button remains disabled when Program Name is empty', { tag: '@sanity' }, async ({ page }) => {
      const programsPage = new ProgramsPage(page);
      await programsPage.openNewProgramForm();
    ...
    test('TC-004: Program can be created with Program Name only', { tag: '@sanity' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test('TC-005: Cancel closes form without creating a program', { tag: '@sanity' }, async ({ page }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test('TC-006: Create button enables after clearing and re-entering Program Name', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
  ...
  test.describe('Negative', () => {
    test('TC-007: Program is not created when submission is blocked by empty name', { tag: '@regression' }, async ({ page }) => {
      const programsPage = new ProgramsPage(page);
      const modal = programsPage.newProgramModal;
    ...
    test('TC-008: Duplicate program name is not allowed', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
      const name = uniqueName('Web Development 2026');
    ...
    test.skip('TC-009: Non-admin user cannot create a program', { tag: '@regression' }, async () => {
      test.skip(true, 'Requires non-admin credentials in .env');
    });

    test('TC-010: Program is not created when create request fails due to server error', { tag: '@api' }, async ({ page }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test('TC-011: XSS payload in Description is not executed in the program list', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
  ...
  test.describe('Edge cases', () => {
    test('TC-012: Program Name at maximum allowed length is accepted', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test('TC-013: Program Name exceeding maximum length is rejected', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
      const modal = programsPage.newProgramModal;
    ...
    test('TC-014: Program Name with special characters is handled correctly', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test('TC-015: Leading and trailing whitespace in Program Name is trimmed', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test('TC-016: Description at maximum allowed length is accepted', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test('TC-017: Unicode and emoji in Program Name are preserved', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test('TC-018: Single-character Program Name is accepted', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test.fixme('TC-019: Rapid double-click on Create does not create duplicate programs', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
