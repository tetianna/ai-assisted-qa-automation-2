...
This file captures which authentication approach to use for which kind of test. It is a building block — combined with other decision files in a later block, it becomes part of a Playwright Skill the agent applies automatically.
