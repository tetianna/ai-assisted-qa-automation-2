...
test.describe('Programs: semester management', () => {
  ...
  test.describe('Happy paths', () => {
    test('TC-001 — Admin adds a semester to a selected program', { tag: '@e2e' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
  ...
  test.describe('Negative', () => {
    test('TC-003 — Semester form unavailable without program selection', { tag: '@sanity' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test('TC-004 — Empty semester name is rejected', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test('TC-005 — Whitespace-only semester name is rejected', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test('TC-006 — End date before start date is rejected', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test('TC-007 — Semester is not created when API fails', { tag: '@api' }, async ({
      page,
      trackProgram,
    }) => {
      const programsPage = new ProgramsPage(page);
  ...
  test.describe('Edge cases', () => {
    test('TC-002 — Cancelling New Semester does not create a semester', { tag: '@sanity' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test('TC-008 — Multiple semesters can be added to one program', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test('TC-009 — Special characters in semester name render correctly', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
    ...
    test('TC-010 — Long semester name is accepted and visible', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const programsPage = new ProgramsPage(page);
