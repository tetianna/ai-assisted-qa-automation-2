...
test.describe('DS-2: Edit Existing Program Details', () => {
  ...
  test.describe('Happy paths', () => {
    ...
    test('TC-001: Edit form opens with current program data pre-populated', { tag: '@sanity' }, async ({ page, trackProgram }) => {
    ...
    test('TC-002: Updated program name is reflected immediately in the list', { tag: '@smoke' }, async ({ page, trackProgram }) => {
      const name = uniqueName('Web Development 2026');
    ...
    test('TC-003: Unchanged fields remain intact when only Description is edited', { tag: '@sanity' }, async ({ page, trackProgram }) => {
    ...
    test('TC-004: Both Name and Description can be updated in a single save', { tag: '@sanity' }, async ({ page, trackProgram }) => {
    ...
    test('TC-005: Cancel discards unsaved edits', { tag: '@sanity' }, async ({ page, trackProgram }) => {
    ...
    test('TC-006: Save button enables when valid changes are made', { tag: '@regression' }, async ({ page, trackProgram }) => {
    ...
    test('TC-024: Close button discards unsaved edits', { tag: '@regression' }, async ({ page, trackProgram }) => {
    ...
    test('TC-025: Escape key discards unsaved edits', { tag: '@regression' }, async ({ page, trackProgram }) => {
  ...
  test.describe('Negative', () => {
    test('TC-007: Empty Name prevents save on edit', { tag: '@regression' }, async ({ page, trackProgram }) => {
    ...
    test.fixme('TC-008: Duplicate name on edit is rejected', { tag: '@regression' }, async ({ page, trackProgram }) => {
    ...
    test.fixme('TC-009: Server error during save does not corrupt program data', { tag: '@api' }, async ({ page, trackProgram }) => {
    ...
    test('TC-010: Non-admin user cannot edit programs', { tag: '@regression' }, async ({ page, trackProgram }) => {
    ...
    test('TC-011: Saving with no changes does not trigger unnecessary update', { tag: '@regression' }, async ({ page, trackProgram }) => {
    ...
    test('TC-026: XSS payload in edited Description is not executed in the program list', { tag: '@regression' }, async ({ page, trackProgram }) => {
  ...
  test.describe('Edge cases', () => {
    test('TC-012: Name at maximum length can be saved on edit', { tag: '@regression' }, async ({ page, trackProgram }) => {
    ...
    test('TC-013: Name exceeding max length is rejected on edit', { tag: '@regression' }, async ({ page, trackProgram }) => {
    ...
    test('TC-014: Special characters in edited Name are preserved', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const name = uniqueName('Web Development 2026');
    ...
    test('TC-015: Leading and trailing whitespace is trimmed on save', { tag: '@regression' }, async ({ page, trackProgram }) => {
    ...
    test('TC-016: Unicode and emoji in edited fields are preserved', { tag: '@regression' }, async ({ page, trackProgram }) => {
    ...
    test('TC-017: Description cleared to empty is handled per product rules', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const name = uniqueName('Web Development 2026');
    ...
    test('TC-018: Rapid double-click on Save does not cause duplicate updates', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const name = uniqueName('Web Development 2026');
    ...
    test('TC-019: Editing program to same name as itself succeeds', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const name = uniqueName('Web Development 2026');
    ...
    test('TC-027: Description at maximum allowed length is accepted on edit', { tag: '@regression' }, async ({ page, trackProgram }) => {
      const name = uniqueName('UX Design Certificate');
    ...
    test('TC-028: Single-character Name is accepted on edit', { tag: '@regression' }, async ({ page, trackProgram }) => {
    ...
    test.fixme('TC-020: Case-only duplicate name on edit is rejected', { tag: '@regression' }, async ({ page, trackProgram }) => {
    ...
    test('TC-021: Renamed program appears in list without page refresh', { tag: '@regression' }, async ({ page, trackProgram }) => {
    ...
    test('TC-022: Whitespace-only Name on edit is rejected', { tag: '@regression' }, async ({ page, trackProgram }) => {
    ...
    test('TC-023: Saving 255-character name on edit completes without hanging', { tag: '@regression' }, async ({ page, trackProgram }) => {
    ...
    test('TC-029: Success feedback shown after save when product displays it', { tag: '@regression' }, async ({ page, trackProgram }) => {
