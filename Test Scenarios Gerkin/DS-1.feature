Feature: Create new academic program
  ...
  Scenario: Admin sees program creation form with required fields
    ...
    And Create and Cancel actions are visible
  ...
  @TC-017
  Scenario: Unicode and emoji in program name are preserved
    Given I am on the program creation form
  ...
  # - Duplicate names not addressed in ACs; case-sensitivity unknown.
  ...
  # - Post-create UX (toast, sort order, navigation) not specified.
  # - AI configuration fields not mentioned in ACs.
